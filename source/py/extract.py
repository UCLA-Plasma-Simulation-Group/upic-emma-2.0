...
try:
    N_nodes=int(input('How many MPI nodes have been used? '))
except ValueError:
    print("Not a number")
    sys.exit()
...
try:
    test=int(input('Mobile ions (1 if true or 0 if false)? '))
except ValueError:
    print("Not a number")
    sys.exit()
    
try:
    test2=int(input('Do you want to plot Fourier transforms? (1 : yes or 0 : no)? '))
except ValueError:
    print("Not a number")
    sys.exit()
